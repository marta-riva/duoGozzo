function [vomma] = calcBsVommaAnalytic(bs_mod_, option_, mkt_data_, ...
    method_, idxs_)
% This function calculates the Black-Scholes vomma
% In
...
vomma = K.*exp(-zr.*tau).*normpdf(d_2).*sqrt(tau).*d_1.*d_2./sigma;
